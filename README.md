...
Graphical user interface for using released TTS and vocoder models in the form of a text editor, made using Tkinter.
...
- NOTE: It will take a while to generate audio, especially if you don't have a CUDA-compatible GPU. The CLI would show what's happening.
- DEV NOTE: Changes to synthesize.py and manage.py may require changes to gui.py. In any case of errors or problems after following the instructions, compare this version of `synthesize.py` with the original version that was overwritten.
